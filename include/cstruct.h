...
ec_pdo_info_t slave_1_pdos[] = {
    {0x1601, 2, slave_1_pdo_entries + 0}, /* write commond of moulde */
    {0x1602, 1, slave_1_pdo_entries + 2}, /* write target of moulde */
    {0x1a00, 2, slave_1_pdo_entries + 3}, /* read ssi of moudle */
    {0x1a05, 8, slave_1_pdo_entries + 5}, /* read ain of moudle */
};
